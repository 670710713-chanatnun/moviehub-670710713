...
function Home() {
  // เริ่มด้วย Array ว่าง แล้วรอรับข้อมูลจาก API
  const [picks, setPicks] = useState([]);

  // เรียกใช้ getMovies() ดึงข้อมูลหนังจาก API (หรือจาก localStorage)
  useEffect(() => {
    let ignore = false;
    getMovies()
      .then(list => { 
    ...
    <div className="mx-auto max-w-5xl px-4 md:px-6">
      ...
      <section className="py-14 md:py-20">
        ...
        <p className="mt-4 max-w-xl text-slate-600">
          ตอนนี้นำเข้าข้อมูลหนังจริงจาก TMDB API แล้ว พร้อมการจัดการข้อมูลแบบ Cache และเตรียมต่อกับระบบ Backend
        </p>
